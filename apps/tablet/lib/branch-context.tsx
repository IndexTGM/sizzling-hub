...
export function BranchProvider({ children }: { children: ReactNode }) {
  ...
  const [branchSlug, setBranchSlugState] = useState<string>("");
  ...
  useEffect(() => {
    ...
    (async () => {
      const found = allBranches.find((b) => b.slug === branchSlug) ?? null;
      setBranch(found);
      if (found) {
